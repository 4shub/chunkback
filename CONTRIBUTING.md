...
apps/api/
├── src/
│   ├── parser/           # CBPL lexer and parser
│   │   ├── lexer/        # Tokenization
│   │   ├── cbpl-parser/  # AST generation
│   │   ├── definitions/  # Generated types (DO NOT EDIT)
│   │   └── types/        # Command type definitions
│   ├── streaming/        # Response streaming logic
│   └── server/           # Express server and routes
├── e2e/                  # End-to-end tests
├── scripts/              # Code generation scripts
├── cbpl.definitions.json # CBPL language definition (source of truth)
└── CBPL.md              # Auto-generated documentation
```
...
Thank you for contributing to Chunkback! 🚀
